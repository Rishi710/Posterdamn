        ...
        <div className="flex h-[100dvh] w-full bg-white dark:bg-black overflow-hidden">
            ...
            <div className="flex w-full flex-col h-full lg:w-[40%]">
                ...
                <div className="flex justify-between items-center p-8 md:p-12 lg:px-20 lg:py-10 text-zinc-500">
                    <Link href="/" className="group flex items-center text-[10px] font-black uppercase tracking-widest hover:text-black dark:hover:text-white transition-colors">
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar px-8 md:px-12 lg:px-20">
                    <div className="mx-auto w-full max-w-sm py-12">
                        <div className="mb-10">
                            <h1 className="text-5xl font-black italic tracking-tighter text-black dark:text-white uppercase">Register</h1>
                        ...
                        <div className="mt-12">
                            <div className="relative mb-8 flex items-center">
                                ...
                                <span className="mx-4 flex-shrink text-[9px] font-black uppercase tracking-widest text-zinc-400">Fast Enrolment</span>
                                <div className="flex-grow border-t border-zinc-100 dark:border-zinc-800"></div>
                            </div>
                            <button
                ...
                <div className="p-8 md:p-12 lg:px-20 lg:py-8 border-t border-zinc-50 dark:border-zinc-900 bg-white dark:bg-black">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="#" className="text-[8px] font-bold text-zinc-400 hover:text-black dark:hover:text-white uppercase tracking-widest">Terms</a>
                        </div>
                    </div>
                </div>
            </div>
