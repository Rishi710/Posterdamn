...
import { ArrowLeft, Mail, Smartphone, ArrowRight } from "lucide-react";
    ...
    return (
        <div className="flex min-h-screen w-full bg-white dark:bg-black">
            ...
            <div className="hidden w-1/2 bg-black lg:block relative overflow-hidden">
                ...
                <img
                    src="https://image.pollinations.ai/prompt/neon%20abstract%20art%20poster%20gallery?width=1000&height=1500&nologo=true"
                    alt="Signup Banner"
                ...
                <div className="absolute bottom-10 left-10 z-20 text-white">
                    ...
                    <p className="mt-4 text-lg text-gray-300 max-w-md">
                        Create an account to unlock exclusive drops, early access, and members-only discounts.
                    </p>
                </div>
            </div>
            ...
            <div className="flex w-full flex-col justify-center px-4 lg:w-1/2 sm:px-12 xl:px-24">
                <div className="mx-auto w-full max-w-md">
                    ...
                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        Already have an account? <Link href="/login" className="font-bold text-black underline hover:text-blue-600 dark:text-white">Sign In</Link>
                    </p>
