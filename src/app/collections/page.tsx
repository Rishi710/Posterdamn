    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black">
            <div className="bg-black py-24 text-center text-white">
                <span className="mb-4 inline-block text-[10px] uppercase tracking-[0.5em] text-zinc-500">Posterdamn Originals</span>
                <h1 className="text-5xl uppercase tracking-tighter sm:text-8xl">Archives</h1>
